...
# --- Parameters Setup ---                        
# fitness = fitness5  ;D =55; NP = 40; L = -5.12* np.ones(D); U = 5.12* np.ones(D)     # Rastrigin Function               
...
fitness = fitness8  ;D = 50; NP = 40; L = -500* np.ones(D); U = 500* np.ones(D)       # Griewank Function    
