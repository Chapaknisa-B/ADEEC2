...
def fitness22(x):    #8 Himmelblau's function  G=4
    term1 = x[0]**2 + x[1] - 11
    term2 = x[0] + x[1]**2 - 7
    term3 = 0.01 * [(x[0] - 3)**2 + (x[1] - 2)**2]
    return (term1**2 + term2**2 + term3)

def fitness23(x):   # Himmelblau's function G=16
    term1 = x[0]**2 + x[1] - 11
    term2 = x[0] + x[1]**2 - 7
    term3 = x[2]**2 + x[3] - 11
    term4 = x[2] + x[3]**2 - 7
...
# fitness = fitness23 ;D = 4; NP = 40; L = -6* np.ones(D); U = 6* np.ones(D)            # Himmelblau's function G == 
fitness = fitness24 ;D = 2; NP = 40; L = -6* np.ones(D); U = 6* np.ones(D)            # Himmelblau's function G == 4
